            ...
            <section className="home grid h-screen pt-32 pb-16">
                <div className="home__container container grid content-center gap-12 lg:max-w-5xl lg:grid-cols-2 lg:items-center">
                    <div className="home__data justify-self-center text-center lg:text-left">
                        <p className="pb-2 font-semibold">Error 440</p>
                        <h1 className="pb-4 text-5xl font-bold lg:text-6xl capitalize">Sesi Anda Telah Berakhir.</h1>
                        ...
                        <Link href="/login" className="inline-flex items-center justify-center rounded-full bg-gray-900 py-4 px-8 font-bold text-white hover:bg-gray-600 hover:cursor-pointer">
                            Kembali ke Login
                        </Link>
                    </div>
