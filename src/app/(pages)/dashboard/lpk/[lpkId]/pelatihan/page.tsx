...
// Update the import path below if SearchInput is located elsewhere, e.g.:
// import { SearchInput } from "@/components/dashboard/SearchInput";
// Update the path below to the correct relative location of SearchInput
// import { SearchInput } from "../../../components/dashboard/SearchInput";
...
export default function PelatihanLpkPage() {
  ...
  const handleEdit = (id: string) => {
    router.push(`/dashboard/lpk/${lpkId}/pelatihan/edit/${id}`);
  };
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-3 mb-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <button
              ...
              onClick={() => router.push(`/dashboard/lpk/${lpkId}/pelatihan/add`)}
            >
              Tambah Pelatihan
            </button>
            {/* <SearchInput
