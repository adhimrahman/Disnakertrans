...
export default function Navbar() {
  ...
  return (
    <header className="text-white p-4 flex flex-wrap justify-between items-center bg-[#3561A1]">
      ...
      >
        <a href="./" className="block lg:inline-block text-white hover:underline">
          Home
        </a>
        <a href="/kegiatan" className="block lg:inline-block text-white hover:underline">
          Kegiatan
        </a>
        <a href="/lapangan-kerja" className="block lg:inline-block text-white hover:underline">
          Lowongan
        </a>
