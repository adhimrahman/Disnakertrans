...
export const CreatePelatihanSchema = z.object({
	judul: z.string().min(5, "Judul harus diisi dan jelas").max(100, "Judul maksimal 100 karakter"),
	deskripsi: z.string().min(5, "Deskripsi harus diisi dan jelas").max(10000, "Deskripsi maksimal 10000 karakter"),
...
export const UpdatePelatihanSchema = z.object({
	...
	judul: z.string().min(5, "Judul harus diisi dan jelas").max(100, "Judul maksimal 100 karakter").optional(),
	deskripsi: z.string().min(5, "Deskripsi harus diisi dan jelas").max(10000, "Deskripsi maksimal 10000 karakter").optional(),
