...
export const createLowonganSchema = z.object({
  ...
  posisi_lowongan: z.string().nonempty("Nama lowongan harus diisi").min(3, "Nama lowongan harus jelas").max(50, "Nama lowongan maksimal 50 karakter"),
...
export const updateLowonganSchema = z.object({
  ...
  posisi_lowongan: z.string().min(3, "Nama lowongan harus jelas").max(50, "Nama lowongan maksimal 50 karakter").optional(),
