...
export const createLowonganSchema = z.object({
  ...
  nama_lowongan: z.string().nonempty("Nama lowongan harus diisi").min(3, "Nama lowongan harus jelas").max(30, "Nama lowongan maksimal 1000 karakter"),
  ...
  range_gaji: z.object({ max: z.string().nonempty("Gaji nonempty harus diisi"), min: z.string().nonempty("Gaji max harus diisi") }),
...
export const updateLowonganSchema = z.object({
  ...
  judul: z.string().min(3, "Judul konten lowongan harus jelas").max(30, "Judul konten maksimal 30 karakter").optional(),
  nama_lowongan: z.string().min(3, "Nama lowongan harus jelas").max(30, "Nama lowongan maksimal 30 karakter").optional(),
  ...
  range_gaji: z.object({ max: z.string().min(1, "Gaji min harus diisi"), min: z.string().min(1, "Gaji max harus diisi") }).optional(),
